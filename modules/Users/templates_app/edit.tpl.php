...
<?php if(IS_EDIT_PAGE){ ?>
<p><a href="<?php print Url::path('users/delete', array('id' => $form->cv('id'))); ?>" onclick="return confirm('<?php print text('userform:delete_warn'); ?>')"><?php print text('userform:delete_link'); ?></a></p>
<?php } ?>
